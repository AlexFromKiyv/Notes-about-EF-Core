...
* Усуває необхідність у більшості коду для доступу до даних, який зазвичай потрібно писати.
...
* Генерація моделі з існуючої БД.
* Створеня моделі вручну шоб відповідала БД.
